...
============================== -->
<?php
if( !get_theme_mod( 'cc_p1_show_contact' ) ){
    return;
}
    $cc_p1_anime_type = get_theme_mod( 'cc_p1_contact_anime', 'fadeInDown'  );
	...
	?>
			<div class="contact-info wow <?php echo $cc_p1_anime_type; ?>" id="contactinfo">
