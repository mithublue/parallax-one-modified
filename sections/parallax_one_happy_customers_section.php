...
============================== -->
<?php
if( !get_theme_mod( 'cc_p1_show_testimony' ) ){
    return;
}
    ...
    $cc_p1_anime_type = get_theme_mod( 'cc_p1_testimonial_anime', 'fadeInDown'  );
...
?>
	<section class="testimonials wow <?php echo $cc_p1_anime_type; ?>" id="customers">
