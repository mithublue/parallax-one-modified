...
============================== -->
<?php
if( !get_theme_mod( 'cc_p1_show_news' ) ){
    return;
}
    ...
    $cc_p1_anime_type = get_theme_mod( 'cc_p1_news_anime', 'fadeInDown'  );
	if($parallax_number_of_posts > 0) {
	?>
		<section class="brief timeline wow <?php echo $cc_p1_anime_type; ?>" id="latestnews">
