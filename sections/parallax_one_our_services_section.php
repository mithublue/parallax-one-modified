...
============================== -->
<?php
if( !get_theme_mod( 'cc_p1_show_service' ) ){
    return;
}
    ...
    $cc_p1_anime_type = get_theme_mod( 'cc_p1_anime', 'fadeInDown'  );
...
?>
		<section class="services wow <?php echo $cc_p1_anime_type; ?>" id="services">
