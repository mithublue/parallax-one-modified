...
function parallax_one_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'cc_p1_show_header', array(
        'sanitize_callback' => 'parallax_one_sanitize_text',
    ));
    $wp_customize->add_control(
        'cc_p1_show_header',
        array(
            'type' => 'checkbox',
            'label' => esc_html__('Show Header','parallax-one'),
            'description' => esc_html__('If this box is checked, the header will toggle on frontpage.','parallax-one'),
    ...
    /* Header animation */
    $wp_customize->add_setting( 'cc_p1_header_anime', array(
        'default' => esc_html__('fadeInDown','parallax-one'),
        'sanitize_callback' => 'parallax_one_sanitize_text',
        'transport' => 'postMessage'
    ));
    $wp_customize->add_control( 'cc_p1_header_anime', array(
        'label'    => esc_html__( 'Appearance animation ( fadeInDown,slideInRight,slideInLeft )', 'parallax-one' ),
        'section'  => 'parallax_one_header_content',
    ...
    $wp_customize->add_setting( 'cc_p1_show_logos', array(
        'sanitize_callback' => 'parallax_one_sanitize_text',
    ));
    $wp_customize->add_control(
        'cc_p1_show_logos',
        array(
            'type' => 'checkbox',
            'label' => esc_html__('Show Logos','parallax-one'),
            'description' => esc_html__('If this box is checked, The Story section will be visible','parallax-one'),
    ...
    /* CONTACT SETTINGS */
    $wp_customize->add_section( 'cc_p1_slider_section' , array(
        'title'       => esc_html__( 'Slideshow section', 'parallax-one' ),
        'priority'    => 10,
    ));

    $wp_customize->add_setting( 'cc_p1_show_slider', array(
        'sanitize_callback' => 'parallax_one_sanitize_text',
    ));
    $wp_customize->add_control(
        'cc_p1_show_slider',
        array(
            'type' => 'checkbox',
            'label' => esc_html__('Show Slideshow','parallax-one'),
            'description' => esc_html__('If this box is checked, The Story section will be visible','parallax-one'),
            'section' => 'cc_p1_slider_section',
            'priority'    => 1,
        )
    );
    /* Contact animation */
    $wp_customize->add_setting( 'cc_p1_slider_anime', array(
        'default' => esc_html__('fadeInDown','parallax-one'),
        'sanitize_callback' => 'parallax_one_sanitize_text',
        'transport' => 'postMessage'
    ));
    $wp_customize->add_control( 'cc_p1_slider_anime', array(
        'label'    => esc_html__( 'Appearance animation ( fadeInDown,slideInRight,slideInLeft )', 'parallax-one' ),
        'section'  => 'cc_p1_slider_section',
        'active_callback' => 'parallax_one_show_on_front',
        'priority'    => 1
    ...
    $wp_customize->add_setting( 'cc_p1_slider_id', array(
        'default' => esc_html__('','parallax-one'),
        'sanitize_callback' => 'parallax_one_sanitize_text',
        'transport' => 'postMessage'
    ));
    $wp_customize->add_control( 'cc_p1_slider_id', array(
        'label'    => esc_html__( 'Slideshow ID', 'parallax-one' ),
        'section'  => 'cc_p1_slider_section',
        'active_callback' => 'parallax_one_show_on_front',
        'priority'    => 1
    ));
    ...
    $wp_customize->add_setting( 'cc_p1_show_service', array(
        'sanitize_callback' => 'parallax_one_sanitize_text',
    ));
    $wp_customize->add_control(
        'cc_p1_show_service',
        array(
            'type' => 'checkbox',
            'label' => esc_html__('Show Service','parallax-one'),
            'description' => esc_html__('If this box is checked, The Service section will be visible','parallax-one'),
    ...
    /* Services animation */
    $wp_customize->add_setting( 'cc_p1_anime', array(
        'default' => esc_html__('fadeInDown','parallax-one'),
        'sanitize_callback' => 'parallax_one_sanitize_text',
        'transport' => 'postMessage'
    ));
    $wp_customize->add_control( 'cc_p1_anime', array(
        'label'    => esc_html__( 'Appearance animation ( fadeInDown,slideInRight,slideInLeft )', 'parallax-one' ),
        'section'  => 'parallax_one_services_section',
        'active_callback' => 'parallax_one_show_on_front',
        'priority'    => 1
    ...
    $wp_customize->add_setting( 'cc_p1_show_story', array(
        'sanitize_callback' => 'parallax_one_sanitize_text',
    ));
    $wp_customize->add_control(
        'cc_p1_show_story',
        array(
            'type' => 'checkbox',
            'label' => esc_html__('Show Story','parallax-one'),
            'description' => esc_html__('If this box is checked, The Story section will be visible','parallax-one'),
    ...
    /* story animation */
    $wp_customize->add_setting( 'cc_p1_story_anime', array(
        'default' => esc_html__('fadeInDown','parallax-one'),
        'sanitize_callback' => 'parallax_one_sanitize_text',
        'transport' => 'postMessage'
    ));

    $wp_customize->add_control( 'cc_p1_story_anime', array(
        'label'    => esc_html__( 'Appearance animation ( fadeInDown,slideInRight,slideInLeft )', 'parallax-one' ),
        'section'  => 'parallax_one_about_section',
        'active_callback' => 'parallax_one_show_on_front',
        'priority'    => 1
    ...
    $wp_customize->add_setting( 'cc_p1_show_team', array(
        'sanitize_callback' => 'parallax_one_sanitize_text',
    ));
    $wp_customize->add_control(
        'cc_p1_show_team',
        array(
            'type' => 'checkbox',
            'label' => esc_html__('Show Team','parallax-one'),
            'description' => esc_html__('If this box is checked, The Story section will be visible','parallax-one'),
    ...
    $wp_customize->add_setting( 'cc_p1_team_anime', array(
        'default' => esc_html__('fadeInDown','parallax-one'),
        'sanitize_callback' => 'parallax_one_sanitize_text',
        'transport' => 'postMessage'
    ));

    $wp_customize->add_control( 'cc_p1_team_anime', array(
        'label'    => esc_html__( 'Appearance animation ( fadeInDown,slideInRight,slideInLeft )', 'parallax-one' ),
        'section'  => 'parallax_one_team_section',
        'active_callback' => 'parallax_one_show_on_front',
        'priority'    => 1
    ...
    $wp_customize->add_setting( 'cc_p1_show_testimony', array(
        'sanitize_callback' => 'parallax_one_sanitize_text',
    ));
    $wp_customize->add_control(
        'cc_p1_show_testimony',
        array(
            'type' => 'checkbox',
            'label' => esc_html__('Show Testimony','parallax-one'),
            'description' => esc_html__('If this box is checked, The Story section will be visible','parallax-one'),
    ...
    /* Services animation */
    $wp_customize->add_setting( 'cc_p1_testimonial_anime', array(
        'default' => esc_html__('fadeInDown','parallax-one'),
        'sanitize_callback' => 'parallax_one_sanitize_text',
        'transport' => 'postMessage'
    ));
    $wp_customize->add_control( 'cc_p1_testimonial_anime', array(
        'label'    => esc_html__( 'Appearance animation ( fadeInDown,slideInRight,slideInLeft )', 'parallax-one' ),
        'section'  => 'parallax_one_testimonials_section',
        'active_callback' => 'parallax_one_show_on_front',
        'priority'    => 1
    ...
    $wp_customize->add_setting( 'cc_p1_show_ribbon', array(
        'sanitize_callback' => 'parallax_one_sanitize_text',
    ));
    $wp_customize->add_control(
        'cc_p1_show_ribbon',
        array(
            'type' => 'checkbox',
            'label' => esc_html__('Show Ribbon','parallax-one'),
            'description' => esc_html__('If this box is checked, The Story section will be visible','parallax-one'),
    ...
    $wp_customize->add_setting( 'cc_p1_show_news', array(
        'sanitize_callback' => 'parallax_one_sanitize_text',
    ));
    $wp_customize->add_control(
        'cc_p1_show_news',
        array(
            'type' => 'checkbox',
            'label' => esc_html__('Show News','parallax-one'),
            'description' => esc_html__('If this box is checked, The Story section will be visible','parallax-one'),
    ...
    /* News animation */
    $wp_customize->add_setting( 'cc_p1_news_anime', array(
        'default' => esc_html__('fadeInDown','parallax-one'),
        'sanitize_callback' => 'parallax_one_sanitize_text',
        'transport' => 'postMessage'
    ));
    $wp_customize->add_control( 'cc_p1_news_anime', array(
        'label'    => esc_html__( 'Appearance animation ( fadeInDown,slideInRight,slideInLeft )', 'parallax-one' ),
        'section'  => 'parallax_one_latest_news_section',
        'active_callback' => 'parallax_one_show_on_front',
        'priority'    => 1
    ...
    $wp_customize->add_setting( 'cc_p1_show_contact', array(
        'sanitize_callback' => 'parallax_one_sanitize_text',
    ));
    $wp_customize->add_control(
        'cc_p1_show_contact',
        array(
            'type' => 'checkbox',
            'label' => esc_html__('Show Contact','parallax-one'),
            'description' => esc_html__('If this box is checked, The Story section will be visible','parallax-one'),
    ...
    /* Contact animation */
    $wp_customize->add_setting( 'cc_p1_contact_anime', array(
        'default' => esc_html__('fadeInDown','parallax-one'),
        'sanitize_callback' => 'parallax_one_sanitize_text',
        'transport' => 'postMessage'
    ));
    $wp_customize->add_control( 'cc_p1_contact_anime', array(
        'label'    => esc_html__( 'Appearance animation ( fadeInDown,slideInRight,slideInLeft )', 'parallax-one' ),
        'section'  => 'parallax_one_contact_section',
        'active_callback' => 'parallax_one_show_on_front',
        'priority'    => 1
